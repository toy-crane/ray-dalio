...
export const REPORTS = {
	...
	irondragon: {
		text:
			"자신의 종목에 대한 감이 확실하고, 실행력도 엄청 나신 분이네요. 멋지십니다. 레버리지로 투자도 하시고, 굳은 신념이 있으신 것 같아요. 하지만 매번 수익을 낼 수 있으면 좋겠지만, 주식 시장에는 우리가 예측할 수 없는 문제들로 등락을 반복하는 만큼 높은 수익보다 이제는 안정적으로 운용하는 것도 좋은 접근일 것 같아요. '첫째도 둘째도 절대로 잃지 않는다'는 워렌 버핏의 원칙처럼 잃지 않는 투자자가 되시길 응원하겠습니다.",
