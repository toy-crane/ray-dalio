...
export const REPORTS = {
	...
	departingbus: {
		text:
			"매 번 투자에 앞서 고민이 많으신 타입이세요. 마음 속에 찜 해놓고, 투자를 망설였던 종목들이 하루가 다르게 오를 때 마음이 아프지 않으셨나요? 게다가 막상 투자하려고 할 때, 내 마음도 몰라주고 또 올라서 투자를 못한 경우가 많으실 것 같아요. 이제는 좀 더 과감하게 장기적으로 투자를 해보는 것을 추천 드려요. 이미 충분히 올랐더라도 미래가 확실하다면 과거에 대한 미련 없이 시작 해보는 것은 어떨까요?",
	...
	alwaysjejari: {
		text:
			"매매를 많이 하는데, 생각보다 수익이 나지 않아 걱정이 많은 스타일인 것 같아요. `이 정보라면 내일 무조건 상한가 간다. 가즈아!!!`를 외치며, 매매를 하지만 시장은 호락호락하지 않죠. 내가 아는 정보와 반대로 움직이거나, 살 때마다 떨어지지 않던가요? `한 두 번은 시장의 흐름을 맞출 순 있지만, 흐름을 영원히 맞추는 것은 불가능하다`는 존 리 대표님의 말씀처럼 장기적으로 종목을 보고, 투자 해보시는 건 어떨까요? ",
	...
	warren: {
		text:
			"투자의 대가 워런 버핏과 비슷한 성향이라니 대단하세요. 지금도 충분히 잘 하고 계십니다. 앞으로도 꾸준히 수입이 생길 때마다 투자를 이어 간다면 곧 경제적 자유를 얻으실 수 있을 것 같아요.  더불어 투자를 하시면서 자신만의 투자 원칙을 만들어 간다면 더욱 멋진 투자자가 되지 않을까 싶습니다. 워렌 버핏님의 장밋빛 미래 응원하겠습니다!!",
	...
	savingking: {
		text:
			"주식에 대한 두려움이 많으신 타입인 것 같아요. 주변에 수익은 커녕 원금도 못 챙긴 분들이 많고, 막상 시도 했더니 손해만 보고 힘드셨죠? 그런데 어떡하죠? 예금 만으로는 부자가 되기 너무 힘든 세상이 왔어요. 부동산과 물가는 하루가 다르게 오르지만 연봉과 재산은 늘 제 자리에요. 이럴 때 일수록 용기를 내어 작은 금액부터 안정적인 종목(ETF, 우량주)에 투자해보는 것은 어떨까요? 저축왕님의 부자가 되는 길 앞으로 응원하겠습니다. ",
	...
	destroyer: {
		text:
			"드디어 만났네요. 가장 극단적인 투자자, 파괴왕님. 거대했던 코로나 하락장이 끝나고, 새로운 파도가 오고 있는데 수익률이 좋지 않네요. 주변 지인의 이야기에, 언론에서 하는 이야기에, 오르는 차트만 보고, 위험한 종목들에 투자를 하시진 않으셨나요? 이제는 충분히 배웠으니, 졸업을 하셔야 할 때입니다. 당분간은 일확천금은 못 보더라도 안정적인 종목(ETF, 우량주)들을 통해서 장기간 기다리면서 자산을 늘리는 방법을 시도 해볼까요? '첫째도 둘째도 절대로 잃지 않는다'는 워렌 버핏의 원칙처럼 지키는 연습부터 시작하시면 좋은 투자자가 되실 수 있을 겁니다.",
