...
export const REPORTS = {
	goldspoon: {
		text:
			"빚 없이 자산을 10억 이상 가진 당신 너무 부러워요. 처음부터 돈이 많으셨다고 해도 부럽고, 일을 통해서 돈을 버셨다고 해도 부럽습니다. 충분히 잘 해오고 계시지만, 자산 대비 주식 비중이 너무 적은 것은 조금 걱정이에요. 미국의 경제 수장 제롬 파월이 최근 자신의 자산 비중을 공개 했는데, 무려 재산의 60% 이상을 주식에 투자하고 있다고 해요. 나머지 40%는 채권과 부동산으로 구성되어 있습니다. 이제는 제롬 파월처럼 여러 자산에 분산 투자하여 가진 자산을 지켜 보시는게 어떨까요?",
	...
	irondragon: {
		text:
			"투자한 종목에 대한 감이 확실하고, 믿음과 실행력이 엄청 나신 분이네요. 멋지십니다. 레버리지로 투자도 하시고, 굳은 신념이 있으신 것 같아요. 하지만 매번 수익을 낼 수 있으면 좋겠지만, 주식 시장에는 우리가 예측할 수 없는 문제들로 등락을 반복하는 하죠. 이제는 높은 수익보다 안정적으로 운용하는 것도 좋은 접근일 것 같아요. '첫째도 둘째도 절대로 잃지 않는다'는 워렌 버핏의 원칙처럼 잃지 않는 투자자가 되시길 응원하겠습니다.",
		hash_tags: "#한 종목에 전 재산을 태워? #바이오는 무너졌냐?",
		r_score: 90,
		p_score: 15,
		i_score: 75,
		b_score: 80,
	...
	bigear: {
		text:
			"주변에서 주식으로 돈을 벌었다고 하면 동공에 엄청난 지진이 일어나는 스타일이시네요.  부동산 투자로  3억 벌었다는 김 부장님, 비트코인으로 5천만원 벌었다는 이 과장님, 테마주로 하루에 500만원 벌었다는 친구까지... 거기서 그치지 않고, 코끼리님은 불나방처럼 '나도 한 번 해볼까'하는 마음에 이 종목, 저 종목을 매입하지만, 결국엔 손해를 보는 유형인 것 같아요. 이럴 때 일수록 코끼리님이 종사하는 분야에서 가장 큰 회사에 장기 투자를 해보시는 건 어떨까요?",
	...
	departingbus: {
		text:
			"매 번 투자에 앞서 고민이 많으신 타입이세요. 마음 속에 찜 해놓고, 투자를 망설였던 종목들이 하루가 다르게 오를 때 마음이 아프지 않으셨나요? 게다가 막상 투자하려고 할 때, 내 마음도 몰라주고 또 올라서 투자를 못한 경우가 많으실 것 같아요. 이제는 좀 더 과감하게 장기적으로 투자를 해보는 것을 추천 드려요. 이미 충분히 올랐더라도 미래가 확실하다면 과거에 대한 미련 없이 시작해 보는 것은 어떨까요?",
	...
	paperfactory: {
		text:
			"아이고.. 주변의 돈을 벌었다는 이야기에 많은 고민 없이 투자하시는 유형인 것 같아요. '주식 잘하는 친구가 추천한 것이니까 괜찮겠지', '저 사람이면 믿을 만 해', '설마 떨어지겠어?' 이런 생각을 하진 않으셨나요? 그리고 나서 '그럼 나도 한 번?' 하는 마음에 뛰어 들지만 생각보다 호락호락하지 않은 시장에 좌절을 많이 하셨을 것 같아요.  이럴 때 일수록 공장장님이 제일 잘 아는 분야의 대장 주식에 장기 투자를 해보시는 건 어떨까요? 성투 하실 수 있을꺼에요 응원할께요!!",
	...
	raydalio: {
		text:
			"레이 달리오는 20세기에는 워렌 버핏이라면 21세기는 레이 달리오라 해도 과언이 아닐 정도로 금융계를 선도하는 인물이에요.  금, 채권, 주식, 원자재 등에 분산하여 투자하는 올 웨더 전략으로 유명한 투자자에요. 수익률이 크진 않지만 꾸준히 자산을 분산하고, 투자를 이끌어 오고 있는 당신. 레이 달리오에 걸맞는 실력을 갖추신 것 같습니다. 앞으로는 주식 뿐만 아니라 채권, 금, 현금, 원자재 등 다양한 자산으로 포트폴리오를 구성 해보시는 것을 추천 드려요.",
	...
	alwaysjejari: {
		text:
			"매매를 많이 하지만 생각보다 수익이 나지 않아 걱정이 많은 스타일인 것 같아요. `이 정보라면 내일 무조건 상한가 간다. 가즈아!!!`를 외치며, 매매를 하지만 시장은 호락호락하지 않죠. 내가 아는 정보와 반대로 움직이거나, 살 때마다 떨어지지 않던가요? `한 두 번은 시장의 흐름을 맞출 순 있지만, 흐름을 영원히 맞추는 것은 불가능하다`는 존 리 대표님의 말씀처럼 장기적으로 종목을 보고, 투자 해보시는 건 어떨까요?  ",
	...
	warren: {
		text:
			"투자의 대가 워런 버핏과 비슷한 성향이라니 대단하세요. 지금도 충분히 잘 하고 계십니다. 앞으로도 꾸준히 수입이 생길 때마다 투자를 이어 간다면 곧 경제적 자유에 가까워질 것 같아요. 더불어 투자를 하시면서 자신만의 투자 원칙을 만들어 간다면 더욱 멋진 투자자가 되지 않을까 싶습니다. 워렌 버핏님의 장밋빛 미래 응원하겠습니다!!",
	...
	savingking: {
		text:
			"주식에 대한 두려움이 많으신 타입인 것 같아요. 주변에 수익은 커녕 원금도 못 챙긴 분들이 많고, 막상 시도 했더니 손해만 보고 힘드셨죠? 그런데 어떡하죠? 예금 만으로는 부자가 되기 너무 힘든 세상이 왔어요. 부동산과 물가는 하루가 다르게 오르지만 연봉과 재산은 늘 제 자리에요. 이럴 때 일수록 용기를 내어 작은 금액부터 안정적인 종목(ETF, 우량주)에 투자해보는 것은 어떨까요? 저축왕님이 부자가 되는 길 앞으로 응원하겠습니다. ",
	...
	destroyer: {
		text:
			"드디어 만났네요. 가장 극단적 투자자인 파괴왕님. 거대했던 코로나 하락장이 끝나고, 새로운 파도가 오고 있는데 수익률이 좋지 않네요. 주변 지인의 이야기에, 언론에서 하는 이야기에, 오르는 차트만 보고, 위험한 종목들에 투자를 하시진 않으셨나요? 이제는 충분히 배웠으니, 졸업을 하셔야 할 때입니다. 당분간은 일확천금은 못 보더라도 안정적인 종목(ETF, 우량주)들을 통해서 장기간 기다리면서 자산을 늘리는 방법을 시도 해볼까요? '첫째도 둘째도 절대로 잃지 않는다'는 워렌 버핏의 원칙처럼 지키는 연습부터 시작하시면 좋은 투자자가 되실 수 있을 겁니다.",
	...
	jessi: {
		text:
			"제시 리버모어는 가격이 오르면 사고, 내리면 공매도를 하는 이른바 추세매매의 창시자에요. 데이 트레이딩 역사에 큰 획을 그은 인물로 많이 회자되고 있어요. 하지만 그도 데이 트레이딩의 위험성을 알았기에 모든 수익을 재투자 하지 않고 일부 수익을 계속해서 인출하며 수익을 실현했다고 해요. 또한 자산 신탁 회사에 일부를 맡김으로써 일정 부분은 항상 현금으로 유지했다는 이야기가 있어요. 데이 트레이딩을 사랑하는 당신. 이제는 제시 리버모어처럼 조금씩 자산을 배분 해보는 것은 어떨까요?",
	...
	vision: {
		text:
			"손정의는 일본에서 활동 중인 한국계 일본 기업인이에요. 대표적인 일본 통신사인 소프트 뱅크를 이끌고 있으며, 세계 최대 벤처 투자펀드인 비전 펀드도 이끌고 있어요. 손정의는 2016년 7월에 은퇴하려 했으나, 인공지능이 인류를 새롭게 바꿀 것에 매료되어 은퇴 계획을 번복하기도 했어요. 그만큼 AI가 가져올 미래에 대해 큰 믿음을 갖고 있는 투자자입니다. 위험하더라도, 장기적으로 투자하는 당신. 멋진 미래에 걸맞는 멋진 수익도 기대할게요!",
